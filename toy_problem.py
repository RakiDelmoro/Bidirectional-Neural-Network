...
def neural_network_two_to_two(data):
    ...
    * - Neuron
    ...
    while True:
        ...
        yield f"Loss: {torch.mean(output_nodes_loss)} Left to right output node: {l2r_output_nodes} Custom gradients: Weights: {l2r_weight_1_gradient, l2r_weight_2_gradient, l2r_weight_3_gradient, l2r_weight_4_gradient} Bias: {l2r_bias_1, l2r_bias_2}"
...
def pytorch_neural_network(data):
    ...
    while True:
        ...
        # optimizer.step()
        yield f'Loss: {nodes_loss.item()} Neuron Activation: {output_nodes} Weights: {weights.grad} Bias: {bias.grad}'
